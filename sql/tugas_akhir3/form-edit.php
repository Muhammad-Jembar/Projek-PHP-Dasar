...
<fieldset>
 ...
 <input type="text" class="tampilan" name="nis" placeholder="ubah nis" value="" />
</p>


<p>
 <label for="nama">Nama: </label>
 <input type="text" class="tampilan2" name="nama" placeholder="ubah nis" value="<?php echo $murid['nama'] ?>" />
...
<textarea name="alamat" id="" cols="20" rows="10"><?php echo $nama['alamat'] ?></textarea>
</p>
